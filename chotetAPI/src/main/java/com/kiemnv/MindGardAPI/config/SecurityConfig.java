    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                                ...
                                .requestMatchers("/api/v1/shopping-lists/**").hasAnyRole("USER", "ADMIN", "PLUS")
                                .requestMatchers("/api/v1/price-book/**").hasAnyRole("USER", "ADMIN", "PLUS")
                                .requestMatchers("/api/v1/receipt-scanner/**").hasAnyRole("USER", "ADMIN", "PLUS")
